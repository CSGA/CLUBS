			...
			<div class="container">
				...
				<div class="row" id="fh5co-works">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-section-heading work-box">
						<h2 class="fh5co-lead">我的多彩社团</h2>
						<div class="fh5co-spacer fh5co-spacer-sm"></div>
					</div>
					<s:iterator value="#session.myclubList" id="union3">
					<a href="club_clubdetails?club_id=<s:property value="#union3.club_id"/>">				
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 text-center fh5co-work-item work-box">
						<figure><img class="img-responsive" src="<s:property value="#union3.clubimage"/>" alt="Free HTML5 Template"></figure>
						<p class="fh5co-category"><s:property value="#union3.club_name"/></p>
