...
$(function(){
	$("#tt").datagrid({
		...
		showPageList:false,
		columns:[[
			{field:'activities_id',title:'活动ID',width:100,halign:"center", align:"left"},
			{field:'clubs_id',title:'社团ID',width:100,halign:"center", align:"left"},
            ...
            {field:'activities_description',title:'活动描述（规则）',width:100,halign:"center", align:"left"},
             {field:'activities_description',title:'活动状态',width:100,halign:"center", align:"left"}
...
<div id="body" region="center" > 
  ...
  <!-- 表格顶部工具按钮 -->
  <div id="tt_btn">
      <a href="addActivity.html"  id="save" class="easyui-linkbutton" iconCls="icon-add" plain="true">新增</a>
