 ...
 * Generated at: 2016-12-12 07:30:31 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">   <head>\n");
      out.write("\n");
      ...
      out.write("\t\t\t\t                    \t\t<label class=\"sr-only\" for=\"form-first-name\">ID</label>\n");
      out.write("\t\t\t\t                        \t<input type=\"text\" name=\"form-first-name\" placeholder=\"ID...\" class=\"form-first-name form-control\" id=\"form-first-name\">\n");
      out.write("\t\t\t\t                        </div>\n");
      out.write("\t\t\t\t                        <div class=\"form-group\">\n");
      out.write("\t\t\t\t                        \t<label class=\"sr-only\" for=\"form-last-name\">学生姓名</label>\n");
      out.write("\t\t\t\t                        \t<input type=\"text\" name=\"form-last-name\" placeholder=\"学生姓名...\" class=\"form-last-name form-control\" id=\"form-last-name\">\n");
      out.write("\t\t\t\t                        </div>\n");
      out.write("\t\t\t\t                        <div class=\"form-group\">\n");
      out.write("\t\t\t\t                        \t<label class=\"sr-only\" for=\"form-about-yourself\">性别</label>\n");
      out.write("\t\t\t\t                        \t<input type=\"text\" name=\"sex\" placeholder=\"性别...\" class=\"form-last-name form-control\" id=\"form-last-name\">\n");
      out.write("\t\t\t\t                        </div>\n");
      ...
      out.write("\t\t                            <div class=\"form-bottom\">\n");
      out.write("\t\t\t\t                        <div class=\"form-group\">\n");
      out.write("\t\t\t\t                        \t<label class=\"sr-only\" for=\"form-email\">学号</label>\n");
      out.write("\t\t\t\t                        \t<input type=\"text\" name=\"stnumber\" placeholder=\"学号...\" class=\"form-email form-control\" id=\"form-email\">\n");
      out.write("\t\t\t\t                        </div>\n");
      out.write("\t\t\t\t                        <div class=\"form-group\">\n");
      out.write("\t\t\t\t                    \t\t<label class=\"sr-only\" for=\"form-password\">密码</label>\n");
      out.write("\t\t\t\t                        \t<input type=\"password\" name=\"form-password\" placeholder=\"密码...\" class=\"form-password form-control\" id=\"form-password\">\n");
      out.write("\t\t\t\t                        </div>\n");
      out.write("\t\t\t\t                        <div class=\"form-group\">\n");
      ...
      out.write("\t\t\t\t                        \t<input type=\"text\" name=\"form-facebook\" placeholder=\"学院...\" class=\"form-facebook form-control\" id=\"form-facebook\">\n");
      out.write("\t\t\t\t                        </div>\n");
      out.write("\t\t\t\t                        <div class=\"form-group\">\n");
      out.write("\t\t\t\t                        \t<label class=\"sr-only\" for=\"form-twitter\">班级</label>\n");
      out.write("\t\t\t\t                        \t<input type=\"text\" name=\"class\" placeholder=\"班级...\" class=\"form-twitter form-control\" id=\"form-twitter\">\n");
      out.write("\t\t\t\t                        </div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t <div class=\"form-group\">\n");
      out.write("\t\t\t\t                        \t<label class=\"sr-only\" for=\"form-twitter\">电话</label>\n");
      out.write("\t\t\t\t                        \t<input type=\"text\" name=\"tel\" placeholder=\"电话...\" class=\"form-twitter form-control\" id=\"form-twitter\">\n");
      out.write("\t\t\t\t                        </div>\n");
      out.write("\t\t\t\t                        \n");
      out.write("\t\t\t\t                        <button type=\"button\" class=\"btn btn-previous\">上一步</button>\n");
