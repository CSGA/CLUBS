...
$(function(){
	$("#tt").datagrid({
		...
		columns:[[
            ...
            {field:'activities_name',title:'社团名称',width:100,halign:"center", align:"left"},
			{field:'activities_time',title:'社团成立时间时间',width:100,halign:"center", align:"left"},
			{field:'activities_place',title:'社团描述',width:100,halign:"center", align:"left"},
            {field:'activities_description',title:'社团图片',width:100,halign:"center", align:"left"},
