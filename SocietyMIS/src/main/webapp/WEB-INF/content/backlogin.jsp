...
<div class="lg">
<form action="club_login" method="post">
    <div class="lg_top"></div>
    <div class="lg_main">
        <div class="lg_m_1">
        
        <input name="club_id" placeholder="社团账号" value="" class="ur" />
        <input name="clubpassword" placeholder="密码" type="password" value="" class="pw" />
        </div>
    </div>
    <div class="lg_foot">
