				...
				<div class="col-md-8 col-md-offset-2">
					<div class="fh5co-hero-wrap">
						<div class="fh5co-hero-intro">
							<h1 class="to-animate hero-animate-1">We love,We make</h1>
			...
			<div class="container">
				...
				<div class="row" id="fh5co-works">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-section-heading work-box">
						<h2 class="fh5co-lead">多彩社团</h2>
						<div class="fh5co-spacer fh5co-spacer-sm"></div>
					</div>
					<s:iterator value="#session.unionList" id="union">
					<a href="club_clubdetails?club_id=<s:property value="#union.club_id"/>">				
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 text-center fh5co-work-item work-box">
						<figure><img class="img-responsive" src="<s:property value="#union.clubimage"/>" alt="Free HTML5 Template"></figure>
						<p class="fh5co-category"><s:property value="#union.club_name"/></p>
						<h3 class="heading">No.<s:property value="#union.club_id"/></h3>
					</div>
					</a>
			    	</s:iterator>
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 text-center fh5co-work-item work-box"> 
						<figure><img class="img-responsive" src="images/work_2.jpg" alt="Free HTML5 Template"></figure>
						<a href=''><p class="fh5co-category">校管乐团</p></a>
					...
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 text-center fh5co-work-item work-box"> 
						...
						<a href=''><p class="fh5co-category">轮滑社</p></a>
					...
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 text-center fh5co-work-item work-box">
						...
						<a href=''><p class="fh5co-category">舞空间</p></a>
